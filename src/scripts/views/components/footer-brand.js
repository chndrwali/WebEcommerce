  ...
  <div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        >
          Ayo tampil keren dengan brand kami!
        </p>
        ...
        <div class="text-center sm:text-left">
          ...
          <ul class="mt-8 space-y-4 text-sm">
            ...
            <li>
              ...
              >
                <span
                  class="text-white transition group-hover:text-red-500"
                >
                  Live Chat
                </span>
                ...
                <span class="relative flex h-2 w-2">
                  <span
                    class="absolute inline-flex h-full w-full animate-ping rounded-full bg-rose-100 opacity-75"
                  ></span>
                  <span
    ...
    <div class="mt-12 border-t border-gray-100 pt-6">
      <div class="text-center sm:flex sm:justify-between sm:text-left">
        <p class="text-sm text-gray-500">
          ...
          <a
            class="inline-block text-white underline transition hover:text-red-500"
            href="/"
          >
            Terms & Conditions
          </a>
