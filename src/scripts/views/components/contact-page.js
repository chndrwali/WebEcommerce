      ...
      <div class="lg:col-span-2 lg:py-12">
        ...
        <div class="mt-8">
          ...
          <address class="mt-2 not-italic">
            Jl.Mentor No.74, Kec.Cicendo Kel.Sukaraja, Kota Bandung, 40175, Jawa Barat , Indonesia
          </address>
        </div>
      </div>
          ...
          <div class="grid grid-cols-1 gap-4 text-center sm:grid-cols-3">
            <div>
              ...
              <label
                ...
                tabindex="0"
              >
                <span class="text-sm"> Recomendations </span>
              </label>
            </div>
            ...
            <div>
              ...
              <label
                ...
                tabindex="0"
              >
                <span class="text-sm"> Bug/Error </span>
              </label>
            </div>
          </div>
